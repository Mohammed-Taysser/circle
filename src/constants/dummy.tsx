...
const POSTS: Post[] = [
  {
    _id: '8f0e6090-e841-495d-8bad-d75f885368ec',
    variant: 'youtube',
    visibility: 'public',
    assets: {
    ...
    user: {
      avatar: avatar13,
      name: 'Aurora Light',
      _id: '50fb3aa7-d6c9-4765-afc3-026751d2161a',
      isVerified: false,
    },
  ...
  {
    _id: 'c6511f71-194a-4ed3-b486-64a8634d47ee',
    variant: 'avatar',
    visibility: 'public',
    assets: {
      avatar: avatar12,
    ...
    user: {
      avatar: avatar12,
      name: 'Cheryl Jesteco',
      _id: '5e73cbd1-a226-4e85-8656-8574f4d10b6e',
      isVerified: false,
    },
  ...
  {
    _id: '4b883cee-b467-47fd-98e3-8def174cef30',
    variant: 'cover',
    visibility: 'friends',
    assets: {
      cover: gallery4,
    ...
    user: {
      ...
      _id: '34586b09-8caa-4ad9-b685-fc73d06e23f0',
      isVerified: true,
    },
  ...
  {
    _id: 'a8cde747-b8bd-4e3a-b512-329ec8f52a90',
    variant: 'blog',
    visibility: 'friends',
    assets: {},
    user: {
      avatar: avatar10,
      name: 'Debbie Bussel',
      _id: '75633f44-c246-4400-ae2b-f460a3840a4a',
      isVerified: true,
    },
  ...
  {
    _id: '4383a127-1add-453c-8ac1-1c0799313819',
    variant: 'gallery',
    visibility: 'private',
    assets: {
    ...
    user: {
      ...
      _id: '23c0e3bd-8567-444b-9b74-687c8e3c11ca',
      isVerified: false,
    },
...
You can also find me on the Developer DAO Discord as codingwithmanny :)`,
  ...
  {
    _id: 'b819d945-7d01-4bf8-b5f9-ee666faa7ae9',
    variant: 'audio',
    visibility: 'private',
    assets: {
      audio,
    ...
    user: {
      avatar: avatar8,
      name: 'Jason Chaffetz',
      _id: 'eb4e16cf-070d-46a5-977d-1edef0d9a94d',
      isVerified: false,
    },
  ...
  {
    _id: '16747b36-5e71-46dd-a72c-09efe14aa185',
    variant: 'video',
    visibility: 'private',
    assets: {
      video,
    ...
    user: {
      avatar: avatar7,
      name: 'Monta Ellis',
      _id: '1ea4a473-d1f5-4381-b3ac-71e5ad00e777',
      isVerified: false,
    },
  ...
  {
    _id: 'eaf888fe-56ff-45de-8a3e-b1feea028cf2',
    variant: 'share',
    visibility: 'public',
    assets: {},
    user: {
      avatar: avatar6,
      name: 'Matraca Berg',
      _id: '00712634-4926-4d54-8cc8-5df42ebe1474',
      isVerified: false,
    },
    publishAt: new Date(),
    isSaved: false,
...
const POST_REACTS = {
  star: [
    {
      _id: 'be73243a-8e5f-47f8-bf21-5499edc8f8e0',
      avatar: avatar1,
      username: 'gtuting0',
    ...
    {
      _id: 'ddfbf092-d391-4c38-9dd7-6f1a2ee5d7f8',
      avatar: avatar10,
      username: 'smote0',
    ...
    {
      _id: 'c391afd0-4d08-4aab-b219-3e0d9d324c68',
      avatar: avatar11,
    ...
    {
      _id: '39d81c15-5fcd-46df-b8e3-3774eed40465',
      avatar: avatar12,
      username: 'aheinrich0',
  ...
  wow: [
    {
      _id: '1b295d7e-6e18-4cf7-9830-8838ec0fdc89',
      avatar: avatar13,
      username: 'callflatt1',
    ...
    {
      _id: '9350436d-ca5c-4a52-a615-1fdeb872beae',
      avatar: avatar2,
      username: 'mbascomb1',
    ...
    {
      _id: 'fd340fa2-93c9-4168-9e02-ecec9c049eb9',
      avatar: avatar3,
    ...
    {
      _id: '32013191-51a5-4074-b23f-933046623258',
      avatar: avatar4,
      username: 'pbamford1',
  ...
  like: [
    {
      _id: 'f1af00dd-faf3-4c7d-8e6c-e37f8027523e',
      avatar: avatar5,
      username: 'mbanting2',
    ...
    {
      _id: '3b9d6fb0-f8e6-4da2-b38e-fb8671c7250e',
      avatar: avatar6,
      username: 'athacke2',
    ...
    {
      _id: 'adf7ce0f-98c0-470f-ae71-9324d9c98fba',
      avatar: avatar7,
      username: 'emilan2',
    ...
    {
      _id: '1a103515-d93a-4fbf-81af-0bf10aa04dc9',
      avatar: avatar8,
      username: 'cjiruch2',
      fullName: 'Albie Orht',
  ...
  love: [
    {
      _id: '661fb1f9-6854-4742-b45e-857620a0f0a6',
      avatar: avatar9,
      username: 'bjenson3',
    ...
    {
      _id: '47c9f776-cfee-482b-8bb4-4da93c1a3e9d',
      avatar: avatar1,
    ...
    {
      _id: '9e28819b-f25f-441a-9ba9-6be9df37f0b8',
      avatar: avatar2,
    ...
    {
      _id: '3feb0e01-da59-4b30-ba6c-3fe7a52e2ed8',
      avatar: avatar3,
      username: 'hkelinge3',
...
const POST_COMMENTS = [
  {
    _id: '720cef3d-30a2-49d8-be94-34d841d73632',
    user: {
      avatar: avatar6,
      name: 'Flossy',
      _id: 'b186cf9f-182e-48a8-a5bd-abc184280921',
    },
  ...
  {
    _id: 'b7834f39-8920-4fab-8606-710d803a7edb',
    user: {
      avatar: avatar7,
      name: 'Marcela',
      _id: '7e04235b-140d-4cdd-9524-9c51436602ec',
    },
  ...
  {
    _id: '19a1c564-2ffd-43ed-9cbb-7745c36b728a',
    user: {
      avatar: avatar8,
      name: 'Aile',
      _id: '31906f70-2015-4397-91b3-81db0dbb9c62',
    },
  ...
  {
    _id: 'c2ecbd74-7374-4761-b2fe-807c23950c69',
    user: {
      avatar: avatar8,
      name: 'Lars',
      _id: '39464ce5-843b-4ed9-9ac5-3a68b024af50',
    },
  ...
  {
    _id: 'c29c2a92-f88b-4cf2-8078-8330bf51b76d',
    user: {
      avatar: avatar9,
      name: 'Trudy',
      _id: '16793a12-874a-4425-b381-50c7a4ef78a2',
    },
  ...
  {
    _id: 'c6c55278-45f8-44ef-b404-e41efe201eb9',
    user: {
      avatar: avatar10,
      name: 'Anastasie',
      _id: 'faff57a2-bb25-4dc8-904a-48bbeb3180b4',
    },
  ...
  {
    _id: 'be911afc-15ed-4075-9fbf-d01aab14fa19',
    user: {
      avatar: avatar11,
      name: 'Flss',
      _id: '43c89b97-63eb-4dbe-95cc-9dcb53275fed',
    },
  ...
  {
    _id: '4a1af446-55b9-45de-bb71-77127ed3e3f3',
    user: {
      avatar: avatar3,
      name: 'Erhard',
      _id: '0bb7c522-71a5-43ab-a54b-69db35fee6d9',
    },
  ...
  {
    _id: 'a792b54f-f496-4f72-bdf9-36d8d860c600',
    user: {
      avatar: avatar2,
      name: 'Rozanna',
      _id: 'eaa09249-ecdb-48a6-a88f-b10f369c6758',
    },
  ...
  {
    _id: '2c84f26b-bd8a-4551-8e91-dfef4c6f7f39',
    user: {
      avatar: avatar5,
      name: 'Eloise',
      _id: 'f3495786-9469-4448-a20b-354cdbd84c24',
    },
...
const BADGES: Badge[] = [
  {
    ...
    label: 'Happy Rock',
    logo: happy,
    body: 'If user earned 70 points credit then unlocked this badge.',
    createdAt: '',
    updatedAt: '',
  },
  {
    ...
    label: 'Target',
    logo: target,
    body: 'If user earned 120 points credit then unlocked this badge.',
    createdAt: '',
    updatedAt: '',
  },
  {
    ...
    label: 'Featured',
    logo: featured,
    body: 'If user earned 130 points credit then unlocked this badge.',
    createdAt: '',
    updatedAt: '',
  },
  {
    ...
    label: 'Spring',
    logo: spring,
    body: 'If user earned 140 points credit then unlocked this badge.',
    createdAt: '',
    updatedAt: '',
  },
  {
    ...
    label: 'Rocket',
    logo: rocket,
    body: 'If user earned 100 points credit then unlocked this badge.',
    createdAt: '',
    updatedAt: '',
  },
  {
    ...
    logo: contentCreator,
    body: 'If user earned 50 points credit then unlocked this badge.',
    createdAt: '',
    updatedAt: '',
  },
  {
    ...
    label: 'Trending',
    logo: trending,
    body: 'If user earned 150 points credit then unlocked this badge.',
    createdAt: '',
    updatedAt: '',
  },
  {
    ...
    label: 'Hot Hunter',
    logo: hotHunter,
    body: 'If user earned 160 points credit then unlocked this badge.',
    createdAt: '',
    updatedAt: '',
  },
  {
    ...
    label: 'Universe',
    logo: universe,
    body: 'If user earned 180 points credit then unlocked this badge.',
    createdAt: '',
    updatedAt: '',
  },
  {
    ...
    label: 'King',
    logo: king,
    body: 'If user earned 250 points credit then unlocked this badge.',
    createdAt: '',
    updatedAt: '',
  },
];
